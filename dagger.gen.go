...
import (
	"context"
	"dagger/wavelog-docker/internal/dagger"
	"encoding/json"
	"fmt"
	"os"
)
...
func (r WavelogDocker) MarshalJSON() ([]byte, error) {
	var concrete struct{}
	return json.Marshal(&concrete)
}

func (r *WavelogDocker) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "WavelogDocker":
		...
		case "ContainerEcho":
			...
			return (*WavelogDocker).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent WavelogDocker
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*WavelogDocker).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
			return nil, fmt.Errorf("unknown function %s", fnName)
		}
	case "":
		return dag.Module().
			WithDescription("A generated module for WavelogDocker functions\n\nThis module has been generated via dagger init and serves as a reference to\nbasic module structure as you get started with Dagger.\n\nTwo functions have been pre-created. You can modify, delete, or add to them,\nas needed. They demonstrate usage of arguments and return types using simple\necho and grep commands. The functions can be called from the dagger CLI or\nfrom one of the SDKs.\n\nThe first line in this comment block is a short description line and the\nrest is a long description with more detail on the module's purpose or usage,\nif appropriate. All modules should have a short description.\n").
			WithObject(
				dag.TypeDef().WithObject("WavelogDocker").
					WithFunction(
